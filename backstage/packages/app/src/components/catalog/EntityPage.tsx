...
const overviewContent = (
  <Grid container spacing={3} alignItems="stretch">
    ...
    {/* Fila 1: Identidad / Actividad */}
    <Grid item xs={12} md={4}>
      <EntityAboutCard variant="gridItem" />
    </Grid>
    <Grid item xs={12} md={4}>
      <EntityRecentGithubActionsRunsCard limit={5} variant="gridItem" />
    </Grid>
    <Grid item xs={12} md={4}>
      <EntityLinksCard />
    </Grid>

    {/* Fila 2: Estructura / Relaciones */}
    <Grid item xs={12} md={4}>
      <EntityHasSubcomponentsCard variant="gridItem" />
    </Grid>
    <Grid item xs={12} md={8}>
      <EntityCatalogGraphCard variant="gridItem" height={420} />
    </Grid>
  </Grid>
);
